...
class PlantSignup extends StatefulWidget {
  @override
  _PlantSignupState createState() => _PlantSignupState();
}

class _PlantSignupState extends State<PlantSignup> {
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                        builder: (BuildContext context) => PlantLogin()));
                  },
                  child: Text(
                    "Sign In",
                    style: TextStyle(
